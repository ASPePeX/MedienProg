========================================================================
    KONSOLENANWENDUNG: Aufgabe 1-Projektübersicht
========================================================================

Diese Aufgabe 1-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Aufgabe 1-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Aufgabe 1.pch und eine 
